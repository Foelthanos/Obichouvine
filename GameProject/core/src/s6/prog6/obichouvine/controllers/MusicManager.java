        ...
        Disposable
{
        ...
        ObiMusic music )
    {
        ...
        // do some logging
        Gdx.app.log( ObichouvineGame.LOG, "Playing music: " + music.name() );
    ...
    public void stop()
    {
        if( musicBeingPlayed != null ) {
            Gdx.app.log( ObichouvineGame.LOG, "Stopping current music" );
    ...
    public void setVolume(
        float volume )
    {
        Gdx.app.log( ObichouvineGame.LOG, "Adjusting music volume to: " + volume );
    ...
    public void dispose()
    {
        Gdx.app.log( ObichouvineGame.LOG, "Disposing music manager" );
        stop();
    }
}